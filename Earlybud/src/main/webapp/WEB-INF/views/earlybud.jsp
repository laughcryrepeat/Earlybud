...
-->
	...
	<link rel='stylesheet' id='airi-style-css' href='css/main/ewwww.css' type='text/css' media='all' />
	...
	<link rel='stylesheet' id='elementor-post-4-css' href='css/main/post-4.css' type='text/css' media='all' />
	...
	<!-- 와디즈css -->
	<link href="css/main/wlayout.css?v=201803151400" rel="stylesheet">
	<link href="css/main/wmain.css?v=20180817" rel="stylesheet">
	<link href="css/main/wprojectcard.css?v=20180529" rel="stylesheet">
	<script type="text/javascript" src="js/main/wMotion.js?v=20181105"></script>
	<!-- 와디즈css끝 -->
	<!-- 추가2 -->
						...
						<nav id="site-navigation" class="main-navigation col-md-8">
							<div class="menu-menu-container">
								<ul id="primary-menu" class="menu">
									<li id="menu-item-43" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-4 current_page_item menu-item-43"><a href="main">Home</a></li>
									<li id="menu-item-44" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-44"><a href="category">소개</a></li>
									<li id="menu-item-44" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-44"><a href="category/0">카테고리</a></li>									
...
<!-- 메인배너와 랭킹 here -->
	<div id="mainContainer" style="padding-top: 0px;">
      <div id="wmainWrap">
...
$(document).ready(function(){
  ...
  $('#rankingSection').mouseenter(function() {
    ...
    /*메인상단슬라이드베너*/
    $('#main-keyvisual').bannerSlide({
      fade: !('ontouchstart' in window),
      autoplay: true,
      autoplaySpeed: 5000
    });
    $('#main-projects-keyvisual').bannerSlide({
      fade: !('ontouchstart' in window),
      autoplay: true,
      autoplaySpeed: 5000
    });
    ...
    /*wadizPicksInvest*/
    $('.wadizpicks-list > ul, #programEventPicks > ul, .exhibition-list > ul, #wadizCastIntro .wadizcast-list > ul').slick({
        infinite: true,
        dots:true,
        cssEase: 'linear',
        autoplay: false,
...
$(window).scroll(function(){
  ...
  if($(window).scrollTop() > 50){
    ...
    $('#newHeader .gnb .gnb-info').removeClass('active');
...
function goInvestMain(cateOfBsns){
  location.href = "/web/winvest/main?_refer_section_st=CTI_0&cateOfBsns="+cateOfBsns;
}
function goImproveInvestMain(mainCategory){
	location.href = "/web/winvest/" + mainCategory;
}
function goRewardMain(custValueCode){

  var url = "/web/wreward/";
  var referSectionSt="?_refer_section_st=CTR_0";

  if(custValueCode === '312') {
    url+= "donation"+referSectionSt;
  } else {
    url+= "category/"+custValueCode+referSectionSt;
  }
