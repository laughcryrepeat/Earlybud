            ...
            <main id="main" class="site-main">
              ...
              <article id="post-1" class="post-1 post type-post status-publish format-standard hentry category-uncategorized">
                ...
                <div id="respond" class="comment-respond">
                  <form action="newprojectCheck" method="post" id="commentform" enctype="multipart/form-data" class="comment-form" novalidate>
                    ...
                    <p class="comment-form-comment"><label for="author">진행자 소개<span class="required">*</span></label> 
                    	<input id="seller_profile" name="seller_profile" type="text" value="" size="30" maxlength="245" required='required' /></p>
