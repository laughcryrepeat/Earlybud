                ...
                <div id="respond" class="comment-respond">
                  <form action="https://demo.athemes.com/airi-shop/wp-comments-post.php" method="post" id="commentform" class="comment-form" novalidate>
                    <p class="comment-form-email"><label for="image">진행자 프로필이미지<span class="required">*</span></label>
                    	<input id="image" name="main_image" type="text" class="upload-name" value="" size="30" maxlength="245" required='required' onclick="check()" readonly/>
                    	<input id="image_file" name="image" type="file" id="submit" class="file-hidden" value="file" required="required"></p>
                    <p class="comment-form-comment"><label for="author">진행자 소개<span class="required">*</span></label> <input id="seller" name="seller" type="text" value="" size="30" maxlength="245" required='required' /></p>
                    <p class="comment-form-author"><label for="email">진행자 활동 지역</label> <input id="email" name="email" type="email" value="" size="30" maxlength="100" aria-describedby="email-notes" required='required' /></p>
