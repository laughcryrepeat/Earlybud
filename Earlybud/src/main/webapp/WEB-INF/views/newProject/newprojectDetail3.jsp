              ...
              <article id="post-1" class="post-1 post type-post status-publish format-standard hentry category-uncategorized">
                ...
                <div id="respond" class="comment-respond">
                  <form action="https://demo.athemes.com/airi-shop/wp-comments-post.php" method="post" id="commentform" class="comment-form" novalidate>
                    <p class="comment-form-comment"><label for="comment">진행자 프로필이미지<span class="required">*</span></label><input name="submit" type="file" id="submit" class="file" value="file" required="required"></p>
                    <p class="comment-form-author"><label for="author">진행자 소개<span class="required">*</span></label> <input id="author" name="author" type="text" value="" size="30" maxlength="245" required='required' /></p>
                    <p class="comment-form-email"><label for="email">진행자 활동 지역</label> <input id="email" name="email" type="email" value="" size="30" maxlength="100" aria-describedby="email-notes" required='required' /></p>
                    <p class="comment-form-url"><label for="url">계좌 등록하기<span class="required">*</span></label> <input id="url" name="url" type="url" value="" size="30" maxlength="200" /></p>
                    <p class="form-submit"><input name="submit" type="submit" id="submit" class="submit" value="검토요청하기" /> <input type='hidden' name='comment_post_ID' value='1' id='comment_post_ID' />
