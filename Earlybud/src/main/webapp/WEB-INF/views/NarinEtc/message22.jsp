	...
	<body onload="getGNB();">
		<div id="wrap"><!-- [D] footer 미노출시(높이값 800px 이하) class="footer_hide" 추가 -->
	        ...
	        <div id="header" role="banner">
	            <div class="inner">
	                <h1 class="talk_title_area">
	                    <a href="http://www.naver.com" class="logo N=a:gnb.naver"><span class="blind">NAVER</span></a>
	                    <a href="/" class="title N=a:gnb.home"><span class="blind">톡톡</span></a>
	                </h1>
	                <div class="gnb_wrap">
	                    <div class="gnb_area">
	                        <div id="gnb">
...
<div class="alarm_footer _noti_footer">
    ...
    <span class="opacity_border_top"></span>
...
<div class="section_friends no_friends open"> <!-- [D] 톡톡친구가 하나도 없으면(모든 class="wrap_list"에 class="hide" 추가되어있으면) class="no_friends" 추가 -->
	...
	<div class="friends_header"> <!-- [D] 검색 버튼 활성화시 class="search_on" 추가-->
		<div class="header_inner">
			<a href="#" role="button" class="go_friends_main"><i class="ico_friends_logo" aria-label="톡톡친구"></i></a>
			<h2 class="title_area">
				<a href="#" class="button_friends_search" role="button">
					<strong class="title" aria-hidden="true">톡톡 가맹점 찾기</strong>
					<i class="ico_friends_search" aria-label="톡톡 가맹점 검색"></i>
				</a>
			</h2>
			<div class="search_area"> <!-- [D] 텍스트 입력시 class="text_on" 추가 -->
				<input type="text" title="search" class="input_search">
				<span class="enter_search">톡톡 가맹점 검색</span>
				<a href="#" class="go_search_delete" role="button">
					<i class="ico_friends_search_delete" aria-label="검색 취소"></i>
				</a>
				<a href="#" class="go_search" role="button">
					<i class="ico_friends_search" aria-label="검색"></i> <!-- [D] 텍스트 입력되면 class="ico_friends_search_on"으로 변경-->
				</a>
			</div>
		</div>
	</div>	
	...
	<div class="_friend_rcmd">
		<div class="wrap_more_friends wrap_list_count_0">
			<!-- [D] wrap_list 갯수의 따른 class 분기처리
				...
				wrap_list 5개 : 클래스 없음
			-->
			<div class="more_friends_list_area">
				<h3 class="list_title_area">
					<a href="#" class="title _closeRcmdBox" role="button">친구 추가 없이 문의하세요!</a>
				</h3>

				<div class="list_content_area">
					<div class="scroll_more_friends">
						<!-- 대메뉴 -->
						<ul class="_friend_rcmd_box more_friends_list">
							<!-- template/pc/friend/friend_rcmd_ctg_box.html  -->
						</ul>
				
						<!-- 소메뉴 -->
						<div class="_friend_rcmd_list wrap_recommend_area hide">
							<div class="recommend_header shopping"> <!-- [D] 메뉴에 따른 클래스 분기처리 class 변경시 title도 같이 변경해 주세요.
																									쇼핑몰 : class="shopping"
																									캠핑·숙박·펜션 : class="camping"
																									여행·레저 : class="travel"
																									의료 : class="medical"
																									전문가 : class="profession"
																									생활서비스 class="life_service"
																								-->
								<a href="#" role="button" class="go_back">
									<i class="ico_friends_recommend_back" aria-label="뒤로가기"></i>
									<strong class="title">쇼핑몰</strong>
								</a>
								<ul class="recommend_category">
									<!-- template/pc/friend/friend_rcmd_ctg_tab.html -->
									<!-- [D] list 관련 클래스 참고사항   1. 활성화시 class="on" 추가 
																				2. 리스트 기본 색상 : #3ea2ff 클래스 추가 없음, 다른 색상의 리스트 : #6eb9ff일 경우 class="bgcolor" 추가 -->
								</ul>
								<span class="category_border"></span>
							</div>
							<ul class="recommend_friends_list hide">
								<!-- template/pc/friend/friend_rcmd_list.html	 -->
							</ul>
						</div>
