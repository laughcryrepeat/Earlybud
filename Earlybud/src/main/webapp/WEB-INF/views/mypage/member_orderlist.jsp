                             ...
                             <tbody style="background:#ffffff;">
                                <tr>
                                    <td style="vertical-align:middle">
                                        <img src="images/ky.png" alt="" style="width:120px;vertical-align:middle">
                                        <div style="display:  inline-block; vertical-align:middle;">
                                        	<a href="airi_like" class="user-link" style=" color: #3498db;font-size: 1.25em;vertical-align:middle;">얼리버드첫상품</a>
                                    		<!-- <div>상품정보</div>
                                    		<span>price : </span>
                                    		<span>q'ty : </span> -->
                                    	</div>
                                    ...
                                    <td style="vertical-align:middle; text-align:center;">
                                        <a href="#"><fmt:formatNumber value=21000 pattern="#,###" /> 원</a>
                                    </td>
                                    <td style="vertical-align:middle; text-align:center;">2019-01-15</td>
                                    <td style="vertical-align:middle; text-align:center;">
